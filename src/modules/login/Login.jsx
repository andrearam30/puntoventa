...
import { Container, Row, Col, Form, Button } from 'react-bootstrap'; // Importa los componentes de Bootstrap
...
const Login = () => {
    ...
    const navigate = useNavigate(); // Obtiene la instancia de navigate

    const handleLogin = () => {
        // Lógica de inicio de sesión...

        // Redirige a otra vista si el inicio de sesión es exitoso
